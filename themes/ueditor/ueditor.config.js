...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //,savePath: [ 'images' ]    //图片保存在服务器端的目录， 默认为空， 此时在上传图片时会向服务器请求保存图片的目录列表，
        ...
        ,catcherPath:"/upload/"                  //图片修正地址，同imagePath
...
, toolbars: [["source","undo","redo","insertunorderedlist","insertorderedlist","unlink","link","cleardoc","pagebreak","insertimage","music","emotion","snapscreen","insertvideo","attachment","blockquote","spechars"]]
